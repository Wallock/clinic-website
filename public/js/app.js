...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.card, .section-title, .doctor-card, .service-icon').forEach(function (el) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      requiredFields.forEach(function (field) {
        if (!field.value.trim()) {
          ...
          var _errorMsg = field.parentNode.querySelector('.error-message');
          if (_errorMsg) {
            _errorMsg.remove();
          }
        }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkclinic_website"] = self["webpackChunkclinic_website"] || [];
